...
This means if you we're to reference a static asset like below, the browser will receive a `404` Not Found error when
requesting that asset.
...
<HotTip>Just remember, when you're referencing a static asset, wrap it with `useAsset`</HotTip>
